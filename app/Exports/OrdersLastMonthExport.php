...
class OrdersLastMonthExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents, WithColumnFormatting, WithMapping
{
    /**
    ...
    */
    ...
    {
        $orders = Order::where('created_at', '>=', \Carbon\Carbon::today()->startOfMonth()->subMonth())
            ->where('created_at', '<', \Carbon\Carbon::now()->startOfMonth())->get();
