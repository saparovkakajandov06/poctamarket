        ...
        <div class="my-account__container __container">
            <div class="my-account__row">
                ...
                <div class="card-product__wrapper">
                    <div class="card-product__header">Sargytlarym</div>
                    <div class="card-product__items">

                        @foreach($productsInOrder as $key => $p)
                            <article class="card-product__item">
                                <div class="card-product__img">
                                    <img src="{{ asset('images/products/little/' . $p->img) }}" alt="">
                                </div>
                                <div class="card-product__content">
                                    <div class="card-product__head">
                                        <a href="#">Sargyt {{ $order->created_at }}</a>
                                        <a href="#">{{ $p->name_tk }}</a>
                                    ...
                                    <div class="card-product__section">
                                        <div class="card-product__section-wrapper">
                                            <div class="card-product__card-info">
                                                <p>Цвет:</p>
                                                <p class="card-product__card-info-bold">{{$p->color_tk }}</p>
                                            </div>
                                            <div class="card-product__card-info">
                                                <p>Размер:</p>
                                                <p class="card-product__card-info-bold"> {{ $p->size }}</p>
                                            </div>
                                            <div class="card-product__card-info">
                                                <p>Кол-во:</p>
                                                <div class="card-product__quantity-selector __quantity">
                                                    <span class="card-product__card-info-bold __count">{{ $p->amount }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-product__section-wrapper">
                                            <div class="card-product__card-info">
                                                ...
                                                <p class="card-product__card-info-price">
                                                    <span class="card-product__card-info-regular-price"><span>{{ number_format($p->amount * $p->price,2,'.','') }}</span> TMT</span>
                                                </p>
                                            </div>
