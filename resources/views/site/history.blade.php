        ...
        <div class="my-account__container __container">
            <div class="my-account__row">
                ...
                <div class="my-account__account account-content">
                    ...
                    <div style="margin-top: 15px;" class="account-content__column">
                        <div class="grey-box__grey-box __js-account-inf-box">
                            ...
                            <div class="grey-box__grey-box-content grey-box__grey-box-content-min-height">
                                <div data-hj-suppress="true">
                                        ...
                                        <h6 class="@switch($ord->status)
                                        @case(0)
                                                new-order-in-history
@break

                                        @case(1)
                                                inprocess-order-in-history
@break

                                        @case(2)
                                                completed-order-in-history
@endswitch"> @switch($ord->status)
                                                @case(0)
                                                Täze
                                                @break
                                    ...
                                    <h4>{{ $ord->created_at }}</h4>
                                    <a href="{{ route('history_detailed',['id'=>$ord->id]) }}">Giňişleýin</a>
