...
@section('content')
                ...
                <div class="card__row">
                    <div class="card__column card-product">
                        <div class="card-product__wrapper">
                            ...
                            <div class="card-product__header">Корзина</div>
                                                ...
                                                <div class="card-product__section-wrapper">
                                                    ...
                                                    <div class="card-product__card-info">
                                                        ...
                                                        <div class="card-product__quantity-selector __quantity">
                                                            ...
                                                            <button class="card-product__quantity-button __js-inc" data-plus="plus" data-id="{{ $key }}">+</button>
                                                ...
                                                <div class="card-product__section-wrapper">
                                                    <div class="card-product__card-info">
                                                        ...
                                                        <p class="card-product__card-info-price">
                                                            ...
                                                            <span class="card-product__card-info-discounted-price"><span>{{ number_format($pInC['price'],2,'.','') }}</span> TMT</span>
                                                        </p>
                                                    </div>
                                                    <div id="cart-count" class="card-product__card-info">
                                                        <p>Итого:</p>
 ...
 <button type="butoon">
                                                ...
                                                <div class="card-product__button-item">
                                                    <button class="cart_quantity_delete" data-id="{{$pInC['id']}}">
                            ...
                            <aside class="card-summary__wrapper">
                                ...
                                <div class="card-summary__content">
                                    <div class="card-summary__info">
                                        <p class="card-summary__info-title">Сумма товаров:</p>
                                        <p class="card-summary__info-value __js-sum"><span>{{ number_format($totalPrice,2,'.','') }}</span> TMT</p>
                                    </div>

                                    <div class="card-summary__info">
                                        <p class="card-summary__info-title">Доставка:</p>
                                    ...
                                    <div class="card-summary__info card-summary__info_last-row">
                                        <p class="card-summary__info-title">К оплате:</p>
                                        <p class="card-summary__info-value __js-last-sum"><span>{{ number_format($totalPrice + 10,2,'.','') }}</span> TMT</p>
                                    </div>
                                    <div class="card-summary__btn-container">
                                        <a href="{{route('check_list')}}" class="card-summary__btn"><span>Купить</span></a>
                                    </div>
                                    <div class="card-summary__duty-info">
                                        <p class="card-summary__duty-info-paragraph-content">Внимание! Стоимость Вашего заказа превышает
                                            эквивалент 100 €. В связи с этим посылка будет облагаться государственной пошлиной в размере<br>
                                            <strong>20.9 €</strong>. Более детально <u><a href="#">здесь</a></u>
                                        </p>
                                    </div>
                                </div>
                            </aside>
                            <aside class="coupon-template__coupon">
                                <div class="coupon-template__toggle-view">
                                    <div class="coupon-template__icon">
                                        <span class="_icon-coupon"></span>
                                        <div class="coupon-template__toggle-view-label">Промокод</div>
                                    </div>
                                </div>
                                <div class="coupon-template__couponForm">
                                    <form class="coupon-template__form coupon-template__form_error">
                                        <input type="text" placeholder="Промокод">
                                        <span class="coupon-template__error-field">Данное поле должно быть заполнено</span>
                                        <div class="coupon-template__close">
                                            <span class="_icon-close"></span>
                                        </div>
                                    </form>
                                </div>
                            </aside>
                            <aside class="answear-club-points__points">
                                <div class="answear-club-points__toggle-view">
                                    <div class="answear-club-points__icon">
                                        <span class="_icon-answer-club"></span>
                                    </div>
                                    <div class="answear-club-points__toggle-view-label">Хочу использовать средства ANSWEARClub</div>
                                </div>
                            </aside>
                                ...
                                <div class="shipment-info__item">
                                    <div class="shipment-info__summary-info">
                                        ...
                                        <div class="shipment-info__shipment-info-label">
                                            <h6>Возвращать легко</h6>
                                            <p>Не подошёл размер? Передумали? Без проблем! Ознакомьтесь, как вернуть товар.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="shipment-info__item">
                                    <div class="shipment-info__summary-info">
                                        ...
                                        <div class="shipment-info__shipment-info-label">
                                            <h6></h6>
                                            <p>До 150 часов с момента отправки посылки со склада.</p>
                                        </div>
                                    </div>
                                </div>
                            </aside>
                ...
                <div class="card__row">
                    <div class="card__column card-product">
                        <div class="card-product__wrapper">
                            ...
                            <div class="card-product__header">Корзина пуста</div>
                                            ...
                                            <div class="card-product__section">
                                                <div class="card-product__section-wrapper">
                                                    ...
                                                    <div class="card-product__card-info">
                                                        <p>Кол-во:</p>
                                                        <div class="card-product__quantity-selector __quantity">
                                                            <button class="card-product__quantity-button __js-dec">-</button>
                                                            <span class="card-product__card-info-bold __count">{{ $pInC['amount'] }}</span>
                                                            <button class="card-product__quantity-button __js-inc">+</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="card-product__section-wrapper">
                        ...
                        <div class="card-summary__summary">
                            <aside class="card-summary__wrapper">
                                ...
                                <div class="card-summary__content">
                                    ...
                                    <div class="card-summary__info">
                                        <p class="card-summary__info-title">Доставка:</p>
                                        <p class="card-summary__info-value __js-dostavka"><span>30</span> TMT</p>
                                    </div>
                            ...
                            <aside class="answear-club-points__points">
                                ...
                                <div class="answear-club-points__points-form">
                                    <div class="answear-club-points__form">
											<span class="answear-club-points__form-label">
												Средства AC<strong class="answear-club-points__form-label-value">0 TMT</strong>
											</span>
                                        <button type="submit" class="answear-club-points__form-submit" disabled>
                                            Ок
                                        </button>
                                    </div>
                                </div>
