            ...
            <div class="row">
                ...
                <div class="col-3 align-self-center">
                    <div class="customize-input float-right">
                        <a href="{{ route('admin_obraz_new') }}" class="custom-select-set form-control bg-white border-0 custom-shadow custom-radius">Новый образ</a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    @foreach($old as $old)
                                        <tr>
                                            ...
                                            <td align="center" style="vertical-align:middle">
                                                <a href="{{ route('admin_obraz_edit',['id'=>$old->id]) }}" title="Изменить"><i class="fas fa-edit"></i></a>
                                                <form action="{{ route('admin_obraz_edit', ['id'=>$old->id]) }}" class="delete-product-form" method="post" style="display:inline-block">
                                                    @csrf
                                                    @method('DELETE');
