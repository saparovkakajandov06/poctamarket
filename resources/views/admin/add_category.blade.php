    ...
    <div class="page-wrapper" style="display:block">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin_categories_new') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" value="1" {{ (old('status') == 1) ? 'checked' : '' }} name="status" class="custom-control-input" id="customCheck11">
