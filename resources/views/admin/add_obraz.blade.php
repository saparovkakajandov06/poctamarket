        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin_obraz_new') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label style="opacity:0">Взрослые</label>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox"  name="is_elder" class="custom-control-input" id="customCheck5">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label style="opacity:0">Дети</label>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox"  name="is_kid" class="custom-control-input" id="customCheck6">
