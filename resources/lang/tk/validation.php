...
return [
    ...
    */
    ...
    'custom' => [
        'phone' => [
            'min' => 'telefon belgiňiz 8 sandan az bolmaly däl',
            'max' => 'telefon belgiňiz 13 sandan köp bolmaly däl',
            'unique' => 'bular ýaly belgili ulanyjy eýýam bar'
        ],
        'password' => [
            'confirmed' => 'parol tassyklamasy deň däl',
            'min' => 'parol 6 simvoldan az',
        ],
    ],
